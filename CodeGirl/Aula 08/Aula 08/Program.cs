 qnamespace Aula_08
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //1 - Jogo de Volei
            //Lembra do nosso time, modelado nas aulas anteriores? Vamos aprimorar e transformar em um Jogo?
            //Classe Jogadora
            ...
            //Criar um método que verifica a condição de jogador, ou seja, um método booleano que retornará true
            //se o jogador está apto a jogar e false se o jogador está suspenso.
            //Aplicar Suspensão: torna um jogador suspenso;
            //Cumprir Suspencao: torna um jogador apto a jogar;
            //Sofrer Lesao: Este método vai gerar aleatoriamente um lesão no jogador.A gravidade da lesão irá se
            //refletir em uma redução de pontos de habilidade do jogador, quanto mais grave maior a redução da qualidade. Crie uma escala de redução de no mínimo 1 ponto até o máximo de 15 % da qualidade;
            ...
            //2 - Locadora de Jogos
            //Seu primeiro cliente é uma Locadora de Jogos, você precisará desenvolver um sistema de controle de locação. Esse sistema deverá conter três classes: Jogo, Cliente e Locadora.
            //Classe Jogo
            //Deve conter os atributos nome; classificação etária; código; ano de lançamento; emprestado, para indicar
            //se o jogo está ou não emprestado no momento; gênero;
            ...
            //Deverão ser construídos métodos construtores para preencher os dados do cliente.Um cliente só poderá ser
            //cadastrado se pelo menos os atributos nome, idade, telefone e código forem fornecidos no momento do
            //cadastro, caso o endereço não seja fornecido, deve ser exibida uma mensagem de erro.
            //Classe Empréstimo
            //Atributos código do jogo, data de locação, data de devolução, valor da locação.O valor do empréstimo
            //pode variar com a data de lançamento do jogo, por exemplo.
            //Deve ser construído um método construtor para preenchimento dos atributos e uma função para renovação
            //do empréstimo.
            //Classe Locadora
            ...
            //Crie um cadastro de clientes que recebe como parâmetro os dados do cliente, faz a validação do código
            //verificando se existe algum cliente cadastrado com aquele código, caso exista imprime uma mensagem na
            //tela de erro: "Não foi possível cadastrar o cliente";
            //Crie um cadastro de jogos que recebe como parâmetro os dados do jogo e faz a validação do código.
            //Crie um método que realiza a listagem de todos os jogos da locadora, uma listagem de jogos por gênero,
            //listagem de jogos por classificação, listagem de jogos que não estejam emprestados;
            //Crie um método que realiza uma consulta de cliente por código;
            //Crie um método que recebe como parâmetro o código do cliente e o código do jogo, apos isso o método deve
            //fazer a verificação se existem cliente e jogo com os respectivos códigos, caso exista ele verifica se o
            //jogo esta ou não emprestado e se o cliente tem idade para o empréstimo. Se todas as condições para
            //empréstimo forem satisfeitas, o método deverá inserir criar uma instância de empréstimo e exibir uma
            //mensagem de sucesso da seguinte forma:
            ...
            //, ele atualiza a condição de emprestado para false, retira o jogo da lista de empréstimos do cliente e
            //imprime a mensagem:
            ...
            //4 - Supermercado
            //Agora é com você: Pense em um Supermercado como cenário da nossa aplicação, identifique as classes e
            //implemente um programa que abstrai um caixa. Vou te dar algumas dicas:
            //Você precisará de uma classe cliente, produto, pedido, e supermercado; Cada produto tem um preço e uma
            //quantidade em estoque. Um pedido de um cliente é composto de itens, onde cada item especifica o produto
            //que o cliente deseja e respectiva quantidade, seu total e formas de pagamento;
            //Você pode ter produtos de limpeza, alimentação, higienize e essa é uma boa classe para aplicar os
            //conceitos de herança;
            //O resultado esperado é que você aplique os conceitos de herança e composição e consiga ao instanciar
            //um supermercado cadastrar produtos, clientes e realizar um pedido.
